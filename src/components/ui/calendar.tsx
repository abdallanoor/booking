  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn(
          "bg-accent text-accent-foreground rounded-full data-[selected=true]:rounded-s-full data-[selected=true]:rounded-e-none",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "relative flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 leading-none font-normal rounded-full",
        ...
        "data-[range-middle=true]:bg-transparent data-[range-middle=true]:rounded-none data-[range-middle=true]:hover:bg-accent/50",
        ...
        modifiers.booked && "text-muted-foreground opacity-60",
        modifiers.disabled &&
    ...
    >
      {props.children}
      {modifiers.booked && (
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-px w-1/2 bg-current pointer-events-none" />
      )}
    </Button>
  );
}
