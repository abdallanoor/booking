...
export function BookingDetailsView({ booking }: BookingDetailsViewProps) {
  ...
  if (!listing) return <div>{t("listing_unavailable")}</div>;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <CardContent>
              ...
              <div className="mt-4 pt-2 flex items-center gap-4 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span>{t("guests_count", { count: guests })}</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="bg-primary/10 p-2 rounded-full">
                    <ShieldCheck className="h-4 w-4 text-primary" />
                  </div>
                  <span>{t("full_protection")}</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          {listing.host && typeof listing.host !== "string" && (
            <Card>
              <CardHeader>
                <CardTitle>{t("hosted_by")}</CardTitle>
              </CardHeader>
