  ...
  if (!bookingId || (!loading && !paymentDetails && !success)) {
    ...
    return (
      <div className="container py-8 text-center">
        ...
        <h1 className="text-2xl font-bold mb-4">{t("finding_booking")}</h1>
        <p className="text-muted-foreground mb-8">
          {t("finding_booking_desc")}
        </p>
              ...
              <div className="space-y-2">
                ...
                <h1 className="text-4xl md:text-6xl font-black text-foreground tracking-tight leading-tight">
                  ...
                  <span className="text-primary italic px-2">
                    {listing?.location.city || t("destination")}
                  </span>
                  !
                </h1>
                  ...
                  <div className="p-6 md:p-8 space-y-8">
                    <div className="flex flex-col md:flex-row justify-between items-start gap-6 md:gap-0">
                      <div className="space-y-1">
                        ...
                        <p
                          className="font-mono font-bold text-2xl text-foreground text-start"
                          dir="ltr"
                        >
                          {booking._id.slice(-8).toUpperCase()}
                        </p>
                      </div>
                      <div className="md:rtl:text-left md:text-right space-y-1">
                        <p className="text-[10px] text-muted-foreground uppercase tracking-[0.2em] font-black">
                          {t("total_paid")}
                        </p>
