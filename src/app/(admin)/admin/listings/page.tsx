...
export default function AdminListingsPage() {
  ...
  const fetchListings = useCallback(async (pageNum: number, status: string) => {
    setLoading(true);
    try {
  ...
  const handleAction = async (id: string, action: "approve" | "delete") => {
    ...
    try {
      ...
      // Re-fetch to ensure pagination remains accurate if list empties
      fetchListings(currentPage, statusFilter);
    } catch {
                                ...
                                <AlertDialogContent>
                                  <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                      ...
                                      permanently delete the listing and remove
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Please provide a reason for rejecting this listing. This will be
              visible to the host.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <div className="py-4">
